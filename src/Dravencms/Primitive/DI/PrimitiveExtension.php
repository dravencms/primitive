...
namespace Dravencms\Primitive\DI;
 ...
 */
class PrimitiveExtension extends Nette\DI\CompilerExtension
{
    ...
    public function loadConfiguration()
    {
        ...
        $builder->addDefinition($this->prefix('primitive'))
            ->setClass('Dravencms\Primitive\Primitive', []);
     ...
     */
    public static function register(Configurator $config, $extensionName = 'primitiveExtension')
    {
        $config->onCompile[] = function (Configurator $config, Compiler $compiler) use ($extensionName) {
            $compiler->addExtension($extensionName, new PrimitiveExtension());
        };
    }
